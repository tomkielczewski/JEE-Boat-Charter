...
public class AvatarServlet extends HttpServlet {
    ...
    public static class Patterns {
         ...
         */
        public static final String AVATAR = "^/[a-z]+/?$";
...
//        Integer id = Integer.parseInt(userId);
        ...
        if (user.isPresent()) {
            ...
            if (avatar != null) {
                service.updateAvatar(userId, avatar.getInputStream());
            }
...
//        Integer id = Integer.parseInt(userId);
        ...
        if (user.isPresent()) {
            ...
            if (avatar != null) {
                if (user.get().getAvatar() == null) {
                    service.setAvatar(userId, avatar.getInputStream());
                }
                else {
//                    String rsp = "This user already has an avatar. Use PUT request to change it.";
                    response.getWriter().write("{\"response\":  \"This user already has an avatar. Use PUT request to change it.\" }");
